...
public class Video {
    ...
    public void validate(final ValidationHandler handler) {
        ...
        if (launchedAt == null) {
            handler.append(Error.with("'launchedAt' should not be empty"));
        }
        if (rating == null) {
            handler.append(Error.with("'rating' should not be empty"));
        }
        if (createdAt == null) {
            handler.append(Error.with("'createdAt' should not be empty"));
        }
        if (updatedAt == null) {
            handler.append(Error.with("'updatedAt' should not be empty"));
        }
    }
